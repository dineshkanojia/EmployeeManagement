...
namespace EmployeeManagement.Controllers
{
    public class EmployeeLeaveController : Controller
    {
        ...
        public EmployeeLeaveController(IConfiguration config)
        {
            ...
            baseEmployeeUrl = new Uri(_config["APIService:Employee"]);
        }
        public IActionResult Index()
        {
            ...
            if (httpResponse.IsSuccessStatusCode)
            {
                ...
                foreach (EmployeeLeave leaveRequest in leaveRequets)
                {
                    ...
                    leaveRequest.LeaveType = leaveRequest.LeaveType;// GetValueFromEnum(Convert.ToInt32(leaveRequest.LeaveType));
        ...
        public IActionResult ApplyLeave(EmployeeLeave leaveRequest)
        {
           ...
           // Uri baseEmployeeUrl = new Uri(_config["APIService: EmployeeLeave"]);
            httpClient.BaseAddress = baseEmployeeUrl;
            ...
            if (httpResponse.IsSuccessStatusCode)
            {
                ...
                httpClient.DefaultRequestHeaders.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Bearer", token);
                httpResponse = httpClient.GetAsync(httpClient.BaseAddress + "Employee/GetAllEmployeeByEmail/?UserEmail=" + userDetails.Email).Result;
